...
async function trendingMovies() {
    let trendings = [];
    await fetch('https://api.themovidb.org/3/trending/movie/day?language=pt-BR', options)
        .then(res => res.json())
        .then(res => res.results.forEach(movie => {
...
let scrollDirectionTopRated = 0; //Direção do scroll
...
scrollDirectionTopRated = setInterval(autoScrollTopRated, 16); // ~60FPS